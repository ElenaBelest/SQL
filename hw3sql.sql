DROP DATABASE IF EXISTS hw_lesson3;
CREATE DATABASE IF NOT EXISTS hw_lesson3;
...
SELECT COUNT(post) AS "Количество рабочих в возрасте от 24 до 49"
FROM staff
...
AVG(age) AS "Средний возраст сотрудников"
FROM staff
GROUP BY post
HAVING (SELECT AVG(age) AS "Средний возраст сотрудников") <= 30; 